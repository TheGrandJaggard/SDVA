...
//         public void AddAction(BaseItem item, int index, int number)
//         {
//             if (dockedItems.ContainsKey(index))
//             {  
...
//         public int MaxAcceptable(BaseItem item, int index)
//         {
...
//                         IDictionary<string, JToken> dockedStateDict= dockedState;
//                         var item = BaseItem.GetFromID(dockedStateDict["item"].ToObject<string>());
